...
public final class Constants {
    ...
    //Multipliers
    public static final double kDriveModifier = 0.55;
    public static final double kSteerModifier = 0.5;
    ...
    public static final double kBallTunnelSpeedDuringDispensing = 1;
